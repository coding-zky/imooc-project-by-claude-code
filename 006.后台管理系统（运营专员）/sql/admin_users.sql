-- =============================================
-- 轻账本后台管理系统 - 超级管理员表初始化脚本
-- =============================================

-- 创建超级管理员表（独立于前台 users 表）
...
-- 预设初始管理员账号（密码: admin123）
-- BCrypt hash for "admin123" using Spring Security BCryptPasswordEncoder
...
SELECT 'admin_users 表创建成功，初始账号: admin / admin123' AS result;